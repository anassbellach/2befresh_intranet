    ...
    <div class="p-6 space-y-8 min-h-screen max-w-7xl mx-auto">
        ...
        <div class="p-6 rounded-3xl bg-white shadow-md">
            ...
            <p class="text-sm text-gray-400 mb-6">
                This chart shows the distribution of klanten across different cities.
            </p>
...
onMounted(() => {
    ...
    new Chart(klantenPerPlaatsChartCtx, {
        ...
        data: {
            labels: Object.keys(props.klanten_per_plaats), // X-axis labels (city names)
            datasets: [
                {
                    label: "Number of Klanten", // Label for the dataset
                    data: Object.values(props.klanten_per_plaats), // Y-axis data (number of klanten)
            ...
            scales: {
                ...
                y: {
                    title: {
                        ...
                        text: "Number of Klanten", // Title text for the Y-axis
