        ...
        <div class="rounded-3xl bg-white shadow-2xl w-full max-w-6xl border border-gray-200">
            <div class="p-4 sm:p-8">
                ...
                <p class="text-xs sm:text-sm text-gray-600 mb-4">
                    Klik op een marker om leverancierdetails op de kaart te bekijken.
                </p>
...
const props = defineProps({
    leveranciers: Array, // Array of supplier data
});
...
const initMap = () => {
    ...
    // Add markers for each leverancier
        ...
        if (leverancier.latitude && leverancier.longitude) {
            ...
            marker.addListener("click", () => {
                infoWindow.setContent(`
                    <div class="p-2">
                        <h3 class="font-bold text-lg text-[#1A1952]">${leverancier.leverancier_bedrijfsnaam}</h3>
